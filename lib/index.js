...
internals.K7Sequelize.prototype.load = function () {
  let sequelize;
  this.settings.connectionOptions.options.operatorsAliases = Sequelize.Op;
...
internals.K7Sequelize.prototype.fixtures = function (database) {
  return sequelizeFixtures.loadFile(database.optionsFixtures.path, database);
};
