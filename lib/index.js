...
internals.K7Sequelize.prototype.load = function () {
  ...
  this.db.fixtures = this.fixtures;
  this.db.optionsFixtures = this.settings.optionsFixtures;

  return this.db;
};

internals.K7Sequelize.prototype.fixtures = function () {
  return sequelizeFixtures.loadFile(this.optionsFixtures.path, this);
};

internals.K7Sequelize.prototype.seed = function (type) {
  type = type === 'down' ? 'down' : 'up';

  const options = this.optionsSeed;
...
internals.K7Sequelize.prototype.migration = function (type) {
  type = type === 'down' ? 'down' : 'up';

  const options = this.optionsMigration;
